            ...
            boxShadow: [
              BoxShadow(
                color: _ProfileColors.cyan
                    .withOpacity(palette.isDark ? 0.30 : 0.18),
                blurRadius: 24,
              ),
            ],
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: RadialGradient(
                ...
                radius: 1.10,
                colors: [
                  _ProfileColors.blue.withOpacity(palette.isDark ? 0.26 : 0.11),
                  Colors.transparent,
                ],
              ),
            ),
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: _ProfileColors.blue.withOpacity(0.22),
                    ),
                  ),
                  child: Text(
                    idLabel,
                ...
                OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(
                      color: _ProfileColors.blue.withOpacity(0.58),
                    ),
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: [
                  widget.color.withOpacity(_hovered ? 0.17 : 0.08),
                  palette.cardFill,
                ],
              ),
              border: Border.all(
                color: widget.color.withOpacity(_hovered ? 0.42 : 0.18),
              ),
              boxShadow: [
                BoxShadow(
                  color: widget.color.withOpacity(_hovered ? 0.24 : 0.09),
              ...
              children: [
                AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: widget.color.withOpacity(0.72),
                        blurRadius: 18,
                      ),
                    ],
                  ),
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color:
                _ProfileColors.blue.withOpacity(palette.isDark ? 0.12 : 0.10),
            blurRadius: 38,
            offset: const Offset(0, 18),
          ),
          BoxShadow(
            color: Colors.black.withOpacity(palette.isDark ? 0.26 : 0.07),
            blurRadius: 42,
            offset: const Offset(0, 18),
          ),
        ],
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color:
                _ProfileColors.cyan.withOpacity(palette.isDark ? 0.08 : 0.05),
            blurRadius: 26,
            offset: const Offset(0, 12),
          ),
          BoxShadow(
            color: Colors.black.withOpacity(palette.isDark ? 0.14 : 0.05),
            blurRadius: 24,
            offset: const Offset(0, 12),
          ),
        ],
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color:
                  _ProfileColors.blue.withOpacity(palette.isDark ? 0.12 : 0.08),
              blurRadius: 20,
            ),
          ],
        ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _ProfileColors.cyan
                        .withOpacity(palette.isDark ? 0.42 : 0.18),
                    blurRadius: 28,
                  ),
                ],
              ),
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: _ProfileColors.cyan.withOpacity(0.45),
                      blurRadius: 14,
                    ),
                  ],
                ),
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                height: 5,
                decoration: BoxDecoration(
                  color: palette.mutedText.withOpacity(0.35),
                  borderRadius: BorderRadius.circular(999),
                ),
              ),
              Padding(
    ...
    return SafeArea(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.black.withOpacity(palette.isDark ? 0.35 : 0.12),
              blurRadius: 32,
              offset: const Offset(0, 18),
            ),
          ],
...
class _StatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(14),
      decoration: BoxDecoration(
        color: color.withOpacity(palette.isDark ? 0.12 : 0.08),
        borderRadius: BorderRadius.circular(18),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: RadialGradient(
          colors: [
            color.withOpacity(palette.isDark ? 0.38 : 0.16),
            color.withOpacity(palette.isDark ? 0.12 : 0.08),
          ],
        ),
        border: Border.all(color: color.withOpacity(0.20)),
        boxShadow: [
          BoxShadow(
            color: color.withOpacity(palette.isDark ? 0.26 : 0.12),
            blurRadius: 20,
          ),
        ],
      ),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: activity.color.withOpacity(0.65),
                        blurRadius: 12,
                      ),
                    ],
                  ),
                ...
                if (!isLast)
                  Expanded(
                    child: Container(
                      width: 2,
                      color: _ProfileColors.cyan
                          .withOpacity(palette.isDark ? 0.26 : 0.20),
                    ),
                  ),
              ],
            ),
...
class _ProfilePalette {
  ...
  Color get shellFill => isDark
      ? const Color(0xFF031532).withOpacity(0.74)
      : Colors.white.withOpacity(0.62);

  Color get shellBorder => isDark
      ? _ProfileColors.blue.withOpacity(0.18)
      : _ProfileColors.blue.withOpacity(0.20);

  Color get cardFill => isDark
      ? const Color(0xFF061936).withOpacity(0.72)
      : Colors.white.withOpacity(0.72);

  Color get innerFill => isDark
      ? const Color(0xFF061831).withOpacity(0.78)
      : const Color(0xFFF4F9FF).withOpacity(0.84);

  Color get cardBorder => isDark
      ? _ProfileColors.blue.withOpacity(0.20)
      : _ProfileColors.blue.withOpacity(0.17);

  Color get controlFill => isDark
      ? const Color(0xFF071B3C).withOpacity(0.72)
      : Colors.white.withOpacity(0.64);

  Color get controlBorder => isDark
      ? _ProfileColors.blue.withOpacity(0.22)
      : _ProfileColors.blue.withOpacity(0.20);

  Color get pillBackground => isDark
      ? Colors.white.withOpacity(0.05)
      : const Color(0xFFEAF4FF).withOpacity(0.80);

...
Future<void> _showUserFormDialog(
  ...
  String selectedRole =
      initialRole ?? (roles.isNotEmpty ? roles.first.roleName : '');
                    ...
                    Expanded(
                      child: users.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) => _UsersTableRow(
                                palette: palette,
                                user: users[index],
                                index: index,
                                onDetails: onDetails,
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        _PageButton(icon: Icons.keyboard_double_arrow_right, palette: palette),
        const Spacer(),
        Container(
          height: 34,
          padding: const EdgeInsets.symmetric(horizontal: 14),

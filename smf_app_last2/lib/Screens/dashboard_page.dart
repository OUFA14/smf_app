...
String _formatTimeAgo(DateTime time) {
                  ...
                  Tooltip(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: palette.primaryBlue.withOpacity(0.20),
                            blurRadius: 18,
                    ...
                    child: InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(18),
                          border: Border.all(
                              color: palette.cardBorder.withOpacity(0.9)),
                          boxShadow: [
                            BoxShadow(
                              color: palette.cardGlow.withOpacity(0.12),
                              blurRadius: 22,
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: selected
                    ? palette.primaryBlue2.withOpacity(0.30)
                    : palette.sidebarBorder.withOpacity(0.18),
              ),
              boxShadow: selected
                  ? [
                      BoxShadow(
  ...
  Widget _buildTabContent({
    ...
    switch (_selectedTab) {
      ...
      case _DashboardTab.roles:
        return _pageShell(
          title: 'Roles',
          subtitle: 'Manage access levels and operational permissions.',
      ...
      case _DashboardTab.announcements:
        return _pageShell(
          title: 'Announcements',
          subtitle: 'Manage and send important updates to your team.',
          child: const AnnouncementsPage(embedded: true),
          palette: palette,
        );
      case _DashboardTab.emergency:
        return _pageShell(
      ...
      case _DashboardTab.settings:
        return SettingsPage(
          palette: palette,
          onOpenRoles: () {
            _selectDashboardTab(_DashboardTab.roles);
          },
          onOpenZones: () {
            _selectDashboardTab(_DashboardTab.zones);
          },
          onOpenDevices: () {
            _selectDashboardTab(_DashboardTab.smfDevices);
          },
        );
    }
  }
              ...
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    _metricCard(
                      title: 'Online Users',
                      value: _isLoadingMetrics ? '...' : '${_dashboardMetrics?.activeUsers ?? 0}',
                      delta: '+12',
                    ...
                    _metricCard(
                      title: 'Active Alerts',
                     value: _isLoadingMetrics ? '...' : '${_dashboardMetrics?.activeAlerts ?? 0}',
                      delta: '-2',
                      deltaLabel: 'from yesterday',
                    ...
                    _metricCard(
                      title: 'Devices',
                      value: _isLoadingMetrics ? '...' : '${_dashboardMetrics?.totalDevices ?? 0}',
                      delta: '+5',
                      deltaLabel: 'from yesterday',
  ...
  Widget _buildSystemStatusRow({
    ...
    final height = width >= 1100 ? 300.0 : 280.0;
    final sosCard = SizedBox(
      height: height,
      child: _metricCard(
    ...
    final qrCard = SizedBox(
      height: height,
      child: _systemOverviewCard(palette: palette),
    );
                    ...
                    children: [
                      if (!isDesktop)
                        IconButton(
                          ...
                          icon:
                              Icon(Icons.menu_rounded, color: palette.heroText),
                        ),
                      const Spacer(),
                      Flexible(
                        child: Wrap(
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(
            color: palette.cardGlow.withOpacity(0.10),
            blurRadius: 14,
            offset: const Offset(0, 0),
          ),
          BoxShadow(
            color: Colors.white.withOpacity(palette.isDark ? 0.05 : 0.02),
            blurRadius: 0,
            spreadRadius: 0,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: RadialGradient(
                    colors: [
                      accent.withOpacity(palette.isDark ? 0.34 : 0.22),
                      accent.withOpacity(0.10),
                    ],
                  ),
                  shape: BoxShape.circle,
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      _legendItem('Online', '120', palette.success, palette),
                      _legendItem('Offline', '40', palette.danger, palette),
                      _legendItem(
                          'Maintenance', '15', palette.warning, palette),
                      _legendItem(
                        'Unknown',
                        '10',
                ...
                children: [
                  if (Scaffold.maybeOf(context)?.hasDrawer ?? false) ...[
                    IconButton(
                      ...
                      onPressed: () => Scaffold.of(context).openDrawer(),
                      icon:
                          Icon(Icons.menu_rounded, color: palette.textPrimary),
                    ),
                    const SizedBox(width: 8),
                  ],
                  Expanded(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                padding: const EdgeInsets.all(24),
                decoration: BoxDecoration(
                  color: alertsPalette.cardBackground.withOpacity(0.6),
                  borderRadius: BorderRadius.circular(26),
                  border: Border.all(color: alertsPalette.cardBorder),
                  boxShadow: [
                    BoxShadow(
                      color: alertsPalette.cardShadow.withOpacity(0.95),
                      blurRadius: 45,
                          ...
                          children: [
                            ...
                            Expanded(
                              child: _alertsToolbarButton(
                                ...
                                onSelected: (value) {
                                  setState(() => _alertDateRange = value);
                                },
                              ),
                            ),
                          ],
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: RadialGradient(
              colors: [
                palette.danger.withOpacity(0.16),
                palette.danger.withOpacity(0.04),
              ],
            ),
            border: Border.all(
  ...
  Widget _alertsAddButton(_DashboardPalette palette) {
    return DecoratedBox(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: palette.primaryBlue2.withOpacity(0.25),
            blurRadius: 30,
            offset: const Offset(0, 10),
          ),
        ],
  ...
  Widget _alertsSearchBar(_DashboardPalette palette) {
    return Container(
      ...
      child: TextField(
        onChanged: (value) {
          setState(() => _alertSearchQuery = value);
        },
  ...
  Widget _alertsToolbarButton({
    ...
    return PopupMenuButton<String>(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: palette.innerCardBackground.withOpacity(
        ...
        children: [
          ...
          if (alerts.isNotEmpty) ...[
            ...
            Row(
              children: [
                Text(
                  'Showing 1 to ${alerts.length} of ${alerts.length} alerts',
                  style: TextStyle(color: palette.textMuted),
                ),
                const Spacer(),
                ...[1, 2, 3, 4].map(
                  (page) => Container(
                    ...
                    decoration: BoxDecoration(
                      color: page == 1
                          ? palette.primaryBlue.withOpacity(0.2)
                          : palette.innerCardBackground,
                    ...
                    child: Text(
                      '$page',
                      style: TextStyle(
                        color: page == 1 ? Colors.white : palette.textMuted,
                        fontWeight: FontWeight.w700,
                      ),
                    ),
                  ),
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color:
                      palette.cardShadow.withOpacity(isSelected ? 0.22 : 0.15),
                  blurRadius: isSelected ? 25 : 18,
                  offset: const Offset(0, 10),
                ),
                if (isSelected)
                  BoxShadow(
                    color: palette.primaryBlue.withOpacity(0.30),
                    blurRadius: 24,
                    spreadRadius: 1,
                  ),
              ],
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [
                        severityColor.withOpacity(0.32),
            ...
            children: [
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(color: palette.warning.withOpacity(0.7)),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(16),
                    ),
                  ),
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  style: OutlinedButton.styleFrom(
                    padding: const EdgeInsets.symmetric(vertical: 16),
                    side: BorderSide(color: palette.success.withOpacity(0.7)),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(16),
                    ),
                  ),
